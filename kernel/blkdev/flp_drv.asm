...
SetUserInterrupts: ;////////////////////////////////////////////////////////////////////////////////////////////////////
;-----------------------------------------------------------------------------------------------------------------------
;? УСТАНОВИТЬ НОВЫЙ ОБРАБОТЧИК ПРЕРЫВАНИЙ НГМД
;-----------------------------------------------------------------------------------------------------------------------
...
;-----------------------------------------------------------------------------------------------------------------------
;< FDC_Status = результат операции
;< FDD_DataBuffer = содержимое сектора (в случае успешного выполнения операции чтения)
;-----------------------------------------------------------------------------------------------------------------------
        pushad
        call    save_timer_fdd_motor
...
;> FDD_Head = номер головки (0-1)
;> FDD_Sector = номер сектора (1-18)
;> FDD_DataBuffer = данные для записи сектор
;-----------------------------------------------------------------------------------------------------------------------
;< FDC_Status = результат операции
;-----------------------------------------------------------------------------------------------------------------------
        pushad
